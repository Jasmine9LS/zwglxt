<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理人账号" prop="jishurenzhanghao">
          <el-input v-model="ruleForm.jishurenzhanghao" 
              placeholder="管理人账号" clearable  :readonly="ro.jishurenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理人账号" prop="jishurenzhanghao">
              <el-input v-model="ruleForm.jishurenzhanghao" 
                placeholder="管理人账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理人姓名" prop="jishurenxingming">
          <el-input v-model="ruleForm.jishurenxingming" 
              placeholder="管理人姓名" clearable  :readonly="ro.jishurenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理人姓名" prop="jishurenxingming">
              <el-input v-model="ruleForm.jishurenxingming" 
                placeholder="管理人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	touxiang : false,
      ...
      rules: {
          jishurenzhanghao: [
                { required: true, message: '管理人账号不能为空', trigger: 'blur' },
          ],
          jishurenxingming: [
          ],
          mima: [
