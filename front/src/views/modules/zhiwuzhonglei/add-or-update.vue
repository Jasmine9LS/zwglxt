<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="植物种类" prop="zhiwuzhonglei">
          <el-input v-model="ruleForm.zhiwuzhonglei" 
              placeholder="植物种类" clearable  :readonly="ro.zhiwuzhonglei"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhiwuzhonglei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhiwuzhongleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
