...
public class PutongyuangongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PutongyuangongEntity user = putongyuangongService.selectOne(new EntityWrapper<PutongyuangongEntity>().eq("yonghuzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(user.getId(), username,"putongyuangong",  "用户" );
    ...
    public R register(@RequestBody PutongyuangongEntity putongyuangong){
    	...
    	PutongyuangongEntity user = putongyuangongService.selectOne(new EntityWrapper<PutongyuangongEntity>().eq("yonghuzhanghao", putongyuangong.getYonghuzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        PutongyuangongEntity user = putongyuangongService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        user.setMima("123456");
        putongyuangongService.updateById(user);
    ...
    public R query(PutongyuangongEntity putongyuangong){
		...
		return R.ok("查询用户成功").put("data", putongyuangongView);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<PutongyuangongEntity> wrapper = new EntityWrapper<PutongyuangongEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = putongyuangongService.selectCount(wrapper);
