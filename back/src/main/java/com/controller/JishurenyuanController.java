...
public class JishurenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JishurenyuanEntity user = jishurenyuanService.selectOne(new EntityWrapper<JishurenyuanEntity>().eq("jishurenzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(user.getId(), username,"jishurenyuan",  "管理员" );
    ...
    public R register(@RequestBody JishurenyuanEntity jishurenyuan){
    	...
    	JishurenyuanEntity user = jishurenyuanService.selectOne(new EntityWrapper<JishurenyuanEntity>().eq("jishurenzhanghao", jishurenyuan.getJishurenzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        JishurenyuanEntity user = jishurenyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        user.setMima("123456");
        jishurenyuanService.updateById(user);
    ...
    public R query(JishurenyuanEntity jishurenyuan){
		...
		return R.ok("查询管理人员成功").put("data", jishurenyuanView);
    }
    ...
    public R update(@RequestBody JishurenyuanEntity jishurenyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(jishurenyuan);
        jishurenyuanService.updateById(jishurenyuan);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JishurenyuanEntity> wrapper = new EntityWrapper<JishurenyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jishurenyuanService.selectCount(wrapper);
